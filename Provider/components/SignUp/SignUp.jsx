          ...
          <div>
            ...
            <div class="form-group">
              <label for="portfolio-link">
                ...
                <span class="optional">(For Artists, Photographers, etc.)</span>
              </label>
              <input
                type="text"
                id="portfolio-link"
            ...
            <div class="consent-box">
              <div class="form-group">
                <label for="consent">
                  ...
                  <span>
                    I agree to the LocalConnect Terms of Service and consent to
                    a background check, including police verification, to be
                    conducted by LocalConnect or its designated partners.
                  </span>
                </label>
              </div>
            </div>
